...
Python piper seems easy
python3 -m piper.http_server -m en_GB-semaine-medium --port 5006

E:\dev-test\py\text-to-speech-web> python3 -m piper.http_server -m en_GB-semaine-medium --port 5006

Dansk
 python3 -m piper.http_server -m da_DK-talesyntese-medium --port 5006
